...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14/12/2023 às 17:53
...
INSERT INTO `cadastro` (`id`, `nome`, `email`, `senha`, `cpf`, `cargo`, `sobre`, `pais`, `endereco`, `imagem`, `tamanho_chinelo`, `tamanho_camiseta`, `tipo_documento`, `tamanho_calca`, `musica`, `data_nascimento`, `idiomas`, `signo`, `formacao`, `pets`, `restricao`, `linkedin`, `fuma`, `interesses`, `voo`, `contry`) VALUES
...
(81, 'Marcus Vinícius Bizerra Moreira', 'moreira.marcus.vb@gmail.com', '@Mariana01', '51775699854', 'Desenvolvedor Front-End', 'Sou um cara extrovertido gosto de estar com meus amigos e familia.', 'Brasil', 'Rua dos Bandeirantes, Vila Bocaina', 'c5513bbf1cefd71ad015501527c75cc4.jpg', '40', 'M', 'CPF', 'M', 'Deixa escondido, Virtux', '2006-07-29', 'Português e Ingles', 'Leon', 'TI', 'Gata (Mia)', 'não', 'https://www.linkedin.com/in/marcusvbmoreira/', 'Não', 'Games, Filmes, Séries, jogos de tabuleiro.', 'brasilia', 'paises');
